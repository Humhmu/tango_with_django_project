...
class Chapter7FormClassTests(TestCase):
    ...
    def test_category_form_class(self):
        ...
        self.assertTrue(
            "CategoryForm" in dir(rango.forms),
        ...
        self.assertEqual(
            type(category_form.__dict__["instance"]),
            Category,
...
class Chapter7CategoryFormAncillaryTests(TestCase):
    ...
    def test_index_link_added(self):
        ...
        self.assertTrue(
            '<a href="/rango/add_category/">Add a New Category</a><br />' in content
        )
    ...
    def test_add_category_form_response(self):
        ...
        self.assertTrue(
            "<h1>Add a Category</h1>" in content,
        ...
        self.assertTrue(
            '<input type="submit" name="submit" value="Create Category" />' in content,
        ...
        self.assertTrue(
            'action="/rango/add_category/"' in content,
    ...
    def test_add_category_functionality(self):
        ...
        """
        self.client.post(
            reverse("rango:add_category"), {"name": "Erlang", "views": 0, "likes": 0}
        )
    ...
    def test_category_exists(self):
        ...
        response = self.client.post(
            reverse("rango:add_category"), {"name": "Python", "views": 0, "likes": 0}
        )

        self.assertTrue(
            "Category with this Name already exists." in response.content.decode(),
...
class Chapter7PageFormClassTests(TestCase):
    ...
    def test_page_form_class(self):
        ...
        self.assertEqual(
            type(page_form.__dict__["instance"]),
            Page,
...
class Chapter7PageFormAncillaryTests(TestCase):
    ...
    def test_add_page_url_mapping(self):
        ...
        try:
            resolved_url = reverse(
                "rango:add_page", kwargs={"category_name_slug": "python"}
            )
        except:
            resolved_url = ""
    ...
    def test_add_page_bad_category(self):
        ...
        """
        response = self.client.get(
            reverse("rango:add_page", kwargs={"category_name_slug": "non-existent"})
        )
