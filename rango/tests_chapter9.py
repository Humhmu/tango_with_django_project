...
class Chapter9RegistrationTests(TestCase):
    ...
    def test_registration_get_response(self):
        ...
        self.assertTrue(
            "<h1>Register for Rango</h1>" in content,
        ...
        self.assertTrue(
            "Rango says: <strong>register here!</strong>" in content,
    ...
    def test_good_form_creation(self):
        ...
        self.assertEqual(
            len(rango.models.UserProfile.objects.all()),
            1,
    ...
    def test_good_registration_post_response(self):
        ...
        self.assertTrue(
            "Rango says: <strong>thank you for registering!</strong>" in content,
        ...
        self.assertTrue(
            '<a href="/rango/">Return to the homepage.</a>' in content,
...
class Chapter9LoginTests(TestCase):
    ...
    def test_login_functionality(self):
        ...
        response = self.client.post(
            reverse("rango:login"), {"username": "testuser", "password": "testabc123"}
        )
...
class Chapter9RestrictedAccessTests(TestCase):
    ...
    def test_bad_request(self):
        ...
        self.assertTrue(
            response.url.startswith(reverse("rango:login")),
...
class Chapter9LinkTidyingTests(TestCase):
    ...
    def test_logged_in_links(self):
        ...
        # These should be present.
        self.assertTrue(
            'href="/rango/restricted/"' in content,
            f"{FAILURE_HEADER}Please check the links in your base.html have been updated correctly to change when users log in and out.{FAILURE_FOOTER}",
        )
        self.assertTrue(
            'href="/rango/logout/"' in content,
            f"{FAILURE_HEADER}Please check the links in your base.html have been updated correctly to change when users log in and out.{FAILURE_FOOTER}",
        )

        # These should not be present.
        self.assertTrue(
            'href="/rango/login/"' not in content,
            f"{FAILURE_HEADER}Please check the links in your base.html have been updated correctly to change when users log in and out.{FAILURE_FOOTER}",
        )
        self.assertTrue(
            'href="/rango/register/"' not in content,
            f"{FAILURE_HEADER}Please check the links in your base.html have been updated correctly to change when users log in and out.{FAILURE_FOOTER}",
        )
    ...
    def test_logged_out_links(self):
        ...
        # These should be present.
        self.assertTrue(
            'href="/rango/login/"' in content,
            f"{FAILURE_HEADER}Please check the links in your base.html have been updated correctly to change when users log in and out.{FAILURE_FOOTER}",
        )
        self.assertTrue(
            'href="/rango/register/"' in content,
            f"{FAILURE_HEADER}Please check the links in your base.html have been updated correctly to change when users log in and out.{FAILURE_FOOTER}",
        )

        # These should not be present.
        self.assertTrue(
            'href="/rango/restricted/"' not in content,
            f"{FAILURE_HEADER}Please check the links in your base.html have been updated correctly to change when users log in and out.{FAILURE_FOOTER}",
        )
        self.assertTrue(
            'href="/rango/logout/"' not in content,
            f"{FAILURE_HEADER}Please check the links in your base.html have been updated correctly to change when users log in and out.{FAILURE_FOOTER}",
        )
...
class Chapter9ExerciseTests(TestCase):
    ...
    def test_add_category_link(self):
        ...
        self.assertTrue(
            reverse("rango:add_category") not in content,
        ...
        self.assertTrue(
            reverse("rango:add_category") in content,
